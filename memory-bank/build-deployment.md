...
- **Dev registry (F30, resolved 2026-08-28)**: Docker Hub `dgilli/selkies-rhel9:latest` — **now = `10c646b392e2`** (GH #6 YAMA/proot-apps fix, 2026-09-18; also pushed as `:papps-fix` and pinned as `:v6-llvmpipe`). Previous: c9 `a4e303101691` (reconciled build, 2026-09-01; `:c9`), c8 `5c835fb6a147` (manifest `sha256:b70d42e3…`), c7 = manifest `sha256:46246466…`. Production pin = **`v6-llvmpipe` = `10c646b392e2`** (registry manifest `sha256:2f57945b9171eee10682c750a85bb59b0b902a70b10487f41d8792e9dcb07ddd`), bumped 2026-09-21 per user decision — immutable tag sequence v2→v3→v4→v5→v6-llvmpipe; old pins stay in the registry for one-step rollbacks. Milestone tag: dropped per user decision 2026-09-01.
